define(['exports', 'aurelia-framework', 'jquery', 'moment', '../utils/custom-element-helper', 'eonasdan-bootstrap-datetimepicker'], function (exports, _aureliaFramework, _jquery, _moment, _customElementHelper) {
  ...
  var Datepicker = exports.Datepicker = (_dec = (0, _aureliaFramework.customElement)('datetimepicker'), _dec2 = (0, _aureliaFramework.inject)(Element), _dec3 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = function () {
